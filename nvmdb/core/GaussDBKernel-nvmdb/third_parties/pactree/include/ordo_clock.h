 ...
 *
 * IDENTIFICATION
 *	  src/gausskernel/storage/nvmdb/core/GaussDBKernel-nvmdb/third_parties/pactree/include/ordo_clock.h
 *
 * -------------------------------------------------------------------------
 */
...
static unsigned long _g_ordo_array[2 * CACHE_DEFAULT_PADDING] read_mostly;
#define g_ordo_boundary (_g_ordo_array[CACHE_DEFAULT_PADDING])
#else
#define g_ordo_boundary ORDO_BOUNDARY
#endif /* ORDO_CONFIGURABLE_BOUNDARY */

static inline void ordo_clock_init(void)
{
#ifdef ORDO_CONFIGURABLE_BOUNDARY
    g_ordo_boundary = ORDO_BOUNDARY;
#endif
}
